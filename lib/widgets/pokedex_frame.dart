...
//* สีของตัวเครื่อง Pokédec (ใช้เฉพาะงานหน้าตา ไม่เกี่ยวกับ logic)
...
//* ธีมของแอป: พื้นหลัง Scaffold = จอ Pokédec, AppBar โปร่งใสให้เห็นจอ
...
//* กรอบเครื่อง Pokédec ครอบทุกหน้าผ่าน MaterialApp.builder
...
//* ตัดมุมจอให้เป็นเหลี่ยมแบบ Pokédec (มุมขวาบน/ซ้ายล่างตัดเยอะกว่า)
